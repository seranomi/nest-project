...
export class ExhibitionArtworkService {
  constructor(
    ...
    @InjectRepository(Exhibition) private readonly exhibitionRepo: Repository<Exhibition>,
    @InjectRepository(Artwork) private readonly artworkRepo: Repository<Artwork>,
  ) {}

  async createExhibitionArtwork(dto: CreateExhibitionArtworkDto): Promise<ExhibitionArtwork> {
